 ...
 */
class HelpmioViewConfigs extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		HelpmioHelper::addSubmenu('configs');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_HELPMIO_TITLE_CONFIGS'), 'configs.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_helpmio&view=configs');
